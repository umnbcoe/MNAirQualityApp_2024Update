...
#################################################################################################
# Altered and updated: April 2024                                                               #
# Editor: Anne Hackman                                                                          #
#################################################################################################
...
ui <- fluidPage(
  ...
  tabsetPanel(
    ...
    # Format was edited during the spring of 2024
    tabPanel("PM2.5 Explained",
             ...
             mainPanel(
               ...
               "For particle pollution, the sensitive groups include people with heart and lung disease, older adults, children, 
                   people with diabetes, and people who are generally more exposed to hazardous conditions because of work or 
                   living circumstances.",
               br(),
               #Summarizes findings
               h5("Reminder: When looking at the data in following tabs, a higher PM2.5 number indicates a worse air quality 
             ...
             sidebarLayout(
               sidebarPanel(
                 ...
                 h3("This tab allows you to explore the seasonal trends in air quality measures. Use the dropdown menus below
                    to compare the seasonal average air quality measures for each site from the years 2015 - 2023."),
             ...
             sidebarLayout(
               ...
               sidebarPanel(
                 h3("This tab allows you to explore the monthly trends in air quality measures. Use the dropdown menus below
                    to plot the monthly average air quality measures for sites from the years 2015 - 2023. When you choose more than five sites,
                 ...
                 selectInput(inputId = "month_year", label = "Choose year:", c("2015" = "2015", "2016" = "2016", "2017" = "2017", "2018" = "2018", "2019" = "2019", "2020" = "2020", "2021" = "2021", "2022" = "2022", "2023" = "2023"),
                             selected = "2023"),
             ...
             sidebarLayout(
               ...
               sidebarPanel(
                 h3("This tab allows you to explore trends in air quality measures related to weather. Use the dropdown menus below
                    ...
                    years 2015 - 2023.  For this tab, only sites located in the Twin Cities area are available."),
    ...
    tabPanel("About the Developers",
             sidebarLayout(
               sidebarPanel(
                 h1("Meet the Team!"),
                 br(),
                 h3("We are a team of graduate students and educators from the Division of
                    Biostatistics and Health Data Science in the School of Public Health at the University of Minnesota.
...
server <- function(input, output) {
  ...
  output$plot <- renderPlotly({
    var1 <- switch(input$year_human_impact, 
                   ...
                   "2021" = "mean_pm2.5_2021_from2.5", "2022" = "mean_pm2.5_2022_from2.5", "2023" = "mean_pm2.5_2023_from2.5")
  ...
  output$text1 <- renderText( { print( "Plot the holiday choosen across the years. 
                                       Start with Juneteenth and see the increase in air quality from 2022 to 2023. Any theories on why that would happen? 
  ...
  output$plot1 <- renderPlotly({
    date <- switch(input$holiday, 
                   "New Year's Day" = c(as.Date("01/01/2015", format = "%m/%d/%Y"), 
                                        ...
                                        as.Date("01/01/2023", format = "%m/%d/%Y")),
                   "Martin Luther King Jr. Day" = c(as.Date("01/19/2015", format = "%m/%d/%Y"), 
                                                    ...
                                                    as.Date("01/17/2022", format = "%m/%d/%Y"),
                                                    as.Date("01/16/2023", format = "%m/%d/%Y")), 
                   "Cinco de Mayo" = c(as.Date("05/05/2015", format = "%m/%d/%Y"), 
                                       ...
                                       as.Date("05/05/2022", format = "%m/%d/%Y"),
                                       as.Date("05/05/2023", format = "%m/%d/%Y")),
                   "Memorial Day" = c(as.Date("05/25/2015", format = "%m/%d/%Y"), 
                                      ...
                                      as.Date("05/30/2022", format = "%m/%d/%Y"),
                                      as.Date("05/29/2023", format = "%m/%d/%Y")),
                   "Last Day of School" = c(as.Date("06/09/2015", format = "%m/%d/%Y"), 
                                            ...
                                            as.Date("06/10/2022", format = "%m/%d/%Y"),
                                            as.Date("06/09/2023", format = "%m/%d/%Y")),
                   "Rosh Hashanah" = c(as.Date("09/15/2015", format = "%m/%d/%Y"), 
                                       ...
                                       as.Date("09/27/2022", format = "%m/%d/%Y"),
                                       as.Date("09/17/2023", format = "%m/%d/%Y")), 
                   "Juneteenth" = c(as.Date("06/19/2015", format = "%m/%d/%Y"), 
                                    ...
                                    as.Date("06/19/2022", format = "%m/%d/%Y"),
                                    as.Date("06/19/2023", format = "%m/%d/%Y")), 
                   "July 4th" = c(as.Date("07/04/2015", format = "%m/%d/%Y"), 
                                  ...
                                  as.Date("07/04/2022", format = "%m/%d/%Y"),
                                  as.Date("07/04/2023", format = "%m/%d/%Y")),
                   "July 5th" = c(as.Date("07/05/2015", format = "%m/%d/%Y"), 
                                  ...
                                  as.Date("07/05/2022", format = "%m/%d/%Y"),
                                  as.Date("07/05/2023", format = "%m/%d/%Y")),
                   "End of Ramadan" = c(as.Date("07/17/2015", format = "%m/%d/%Y"), 
                                        ...
                                        as.Date("05/02/2022", format = "%m/%d/%Y"),
                                        as.Date("04/20/2023", format = "%m/%d/%Y")),
                   "Labor Day" = c(as.Date("09/07/2015", format = "%m/%d/%Y"), 
                                   ...
                                   as.Date("09/06/2021", format = "%m/%d/%Y"),
                                   as.Date("09/05/2022", format = "%m/%d/%Y"),
                                   as.Date("09/04/2023", format = "%m/%d/%Y")), 
                   "Talk Like a Pirate Day" = c(as.Date("09/19/2015", format = "%m/%d/%Y"), 
                                                ...
                                                as.Date("09/19/2022", format = "%m/%d/%Y"),
                                                as.Date("09/19/2023", format = "%m/%d/%Y")),
                   "US Indigenous People's Day" = c(as.Date("10/12/2015", format = "%m/%d/%Y"), 
                                                    ...
                                                    as.Date("10/10/2022", format = "%m/%d/%Y"),
                                                    as.Date("10/09/2023", format = "%m/%d/%Y")), 
                   "Halloween" = c(as.Date("10/31/2015", format = "%m/%d/%Y"), 
                                   ...
                                   as.Date("10/31/2022", format = "%m/%d/%Y"),
                                   as.Date("10/31/2023", format = "%m/%d/%Y")), 
                   "Thanksgiving" = c(as.Date("11/26/2015", format = "%m/%d/%Y"), 
                                      ...
                                      as.Date("11/24/2022", format = "%m/%d/%Y"),
                                      as.Date("11/23/2023", format = "%m/%d/%Y")), 
                   "Day after Thanksgiving" = c(as.Date("11/27/2015", format = "%m/%d/%Y"), 
                                                ...
                                                as.Date("11/25/2022", format = "%m/%d/%Y"),
                                                as.Date("11/24/2023", format = "%m/%d/%Y")), 
                   "Christmas Day" = c(as.Date("12/25/2015", format = "%m/%d/%Y"), 
                                       ...
                                       as.Date("12/25/2022", format = "%m/%d/%Y"),
                                       as.Date("12/25/2023", format = "%m/%d/%Y")), 
  ...
  output$plot2 <- renderPlotly({date <- switch(input$holiday, 
                                               ...
                                               "Martin Luther King Jr. Day" = c(as.Date("01/19/2015", format = "%m/%d/%Y"), 
                                                                                ...
                                                                                as.Date("01/16/2017", format = "%m/%d/%Y"), 
                                                                                as.Date("01/15/2018", format = "%m/%d/%Y"), 
                                                                                as.Date("01/21/2019", format = "%m/%d/%Y"),
                                                                                as.Date("01/20/2020", format = "%m/%d/%Y"),
                                                                                as.Date("01/18/2021", format = "%m/%d/%Y"),
                                                                                as.Date("01/17/2022", format = "%m/%d/%Y"),
                                                                                as.Date("01/16/2023", format = "%m/%d/%Y")), 
