...
yearly_data <- select(yearly_data, site.name, mean_pm2.5_2015_from2.5, mean_pm2.5_2016_from2.5, mean_pm2.5_2017_from2.5, 
                      mean_pm2.5_2018_from2.5, mean_pm2.5_2019_from2.5, mean_pm2.5_2020_from2.5, mean_pm2.5_2021_from2.5, 
                      mean_pm2.5_2022_from2.5, mean_pm2.5_2023_from2.5, interstate, distance_mi, name_pp, fuel_type, PP_distance_mi,med_income, pop_density)
